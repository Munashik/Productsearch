...
function Productlist(props) {
  console.log("line 1 in Productlist")
  ...
  var  product = [
      ...
      const filteredproduct = product.filter((p) => {
        return p.title.toLocaleLowerCase().includes(Searchname)
      })
  ...
  <div className="container" style={{backgroundColor: 'yellow', height: '100px'}}>
    <a className="navbar-brand" href="#">
    Search:<input type="text" onChange={onSearchChange} /> <button>search</button>
    </a>
  </div>
</nav>
